  ...
  return (
    <div className="fixed bottom-5 right-5 z-50 flex flex-col items-center gap-3">
      <button
        ...
        aria-label={locale === 'ru' ? 'Наверх' : 'Жоғары'}
        className={`flex h-11 w-11 items-center justify-center rounded-full border border-gold/40 bg-emerald-900/90 text-gold-light shadow-lg backdrop-blur transition hover:bg-emerald-800 ${
      ...
      <a
        ...
        className="flex h-14 w-14 items-center justify-center rounded-full bg-whatsapp text-emerald-900 shadow-xl transition hover:brightness-110"
      >
